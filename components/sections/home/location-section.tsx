...
export function LocationSection() {
  return (
    <section id="location" className="section-band pb-16 pt-16 sm:pb-20 sm:pt-20 lg:pb-24 lg:pt-24">
      <SiteShell>
        <Reveal>
          <SectionHeading
            eyebrow="Локация"
            title="Адрес и маршрут находятся там, где пользователь уже готов к записи."
            description="Финальный блок закрывает практический вопрос: где студия, как открыть маршрут и куда перейти после просмотра расписания."
          />
        </Reveal>
        ...
        <div className="mt-10 grid gap-5 xl:grid-cols-[360px_minmax(0,1fr)]">
          ...
          <Reveal delay={0.08}>
            <div className="liquid-glass overflow-hidden rounded-2xl p-2">
