      ...
      <SiteShell>
        <Reveal>
          <SectionHeading
            ...
            title="У каждого преподавателя — свой фокус в работе."
            description="Дима ведёт хип-хоп-микс, Ева — контемп, Яна — женственный хип-хоп и леди-хорео. Открой карточку, чтобы узнать о занятиях подробнее."
          />
        </Reveal>
