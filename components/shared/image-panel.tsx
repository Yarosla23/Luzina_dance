...
export function ImagePanel({
  ...
  return (
    <article
      className={cn(
        "group relative overflow-hidden rounded-3xl border border-white/14 bg-[#13090c]",
        className,
      )}
    >
      <div
      ...
      >
        ...
        {contentPosition === "overlay" && hasContent ? (
          <div className={cn("absolute inset-x-0 bottom-0 border-t border-white/10 p-6 sm:p-7", contentClassName)}>
