  ...
  return (
    ...
    >
      ...
      >
        ...
        <defs>
          <linearGradient id="dancePathWarm" x1="0" x2="1" y1="0" y2="0">
            <stop offset="0%" stopColor="#5c0007" stopOpacity="0" />
            <stop offset="46%" stopColor="#5c0007" stopOpacity="0.95" />
            <stop offset="100%" stopColor="#ffffff" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="dancePathCool" x1="0" x2="1" y1="0" y2="0">
            <stop offset="0%" stopColor="#ffffff" stopOpacity="0" />
            <stop offset="55%" stopColor="#5c0007" stopOpacity="0.9" />
            <stop offset="100%" stopColor="#5c0007" stopOpacity="0" />
          </linearGradient>
        </defs>
      </motion.svg>
      ...
      {beatDots.map((dot, index) => (
        <motion.span
          key={`${dot.x}-${dot.y}`}
          className="absolute h-2 w-2 rounded-full border border-white/60 bg-accent-strong shadow-[0_0_24px_rgba(92,0,7,0.55)]"
