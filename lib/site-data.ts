...
export const homeSchedule = [
  {
    day: "Понедельник",
    sessions: [
      { time: "16:00", direction: "Контемп", teacher: "Ева и Лиза", level: "Начальный уровень" },
      { time: "18:00", direction: "Контемп", teacher: "Ева и Лиза", level: "Открытый уровень" },
    ],
  },
  {
    day: "Вторник",
    sessions: [
      { time: "16:00", direction: "Хип-хоп микс", teacher: "Дима", level: "Начальный уровень" },
      { time: "18:00", direction: "Хип-хоп герли", teacher: "Яна", level: "Открытый уровень" },
    ],
  },
  {
    day: "Среда",
  ...
  },
  {
    day: "Пятница",
    sessions: [
      { time: "17:00", direction: "Контемп", teacher: "Ева", level: "Открытый уровень" },
      { time: "18:30", direction: "Открытая хореография", teacher: "Команда студии", level: "Все уровни" },
    ],
  },
  {
    day: "Суббота",
    sessions: [
      { time: "12:00", direction: "Практика / съемка", teacher: "Студия", level: "Все уровни" },
      { time: "14:00", direction: "Дополнительный класс", teacher: "По анонсу", level: "По набору" },
    ],
  },
] as const;
